          ...
          <div className="md:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-venice-light mb-6 max-w-md leading-relaxed">
                Discover and showcase applications built with Venice.ai's
                private AI API. Join the future of unrestricted artificial
                intelligence.
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-venice pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <a
                href="#"
                className="text-venice-light hover:text-venice-coral transition-colors text-sm"
              >
                Privacy Policy
              </a>
              <a
